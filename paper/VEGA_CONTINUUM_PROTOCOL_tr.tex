...
\title{VEGA CONTINUUM PROTOCOL: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA CONTINUUM PROTOCOL'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
